const Map<String, String> en = {
  ...
  'rideSummaryAiProSubtitle':
      'Personal analysis based on your ride and history.',
  'rideSummaryAiFreeSubtitle': 'A quick overview of your completed ride.',
  'rideSummaryAnalyzing': 'Analyzing your ride...',
  'rideSummaryAnalysisUnavailable': 'Ride analysis is unavailable right now.',
  ...
  'rideSummaryHeader': 'MUNJA RIDE SUMMARY',
  ...
  'noSkinsAvailableYet': 'No skins available yet',
  'skinsAvailableLater':
      'Skins for this bike will appear here when they become available.',
  'noFramesAvailableYet': 'No frames available yet',
  'framesAvailableLater':
      'Frames for this bike will appear here when they become available.',
  'findAndManageRiders': 'Find and manage riders',
  'unlockProExperience': 'Unlock Pro experience',
  'munjaProIsActive': 'Munja Pro is active',
  'unlockMoreOfMunja': 'Unlock more of Munja',
  'proFeaturesUnlocked':
  ...
  'socialCaps': 'SOCIAL',
  'competeCaps': 'COMPETE',
  'profileSignOutDescription': 'You will return to the login screen.',
  'profileSignOutDialogTitle': 'Sign out of Munja?',
  'profileSignOutDialogMessage':
      'Your local rides and settings stay on this device.',
  'profileSignOutFailed': 'Sign out failed. Please try again.',
  ...
  'challengeWithRider':
      'A 1 vs 1 challenge with {rider} is the next Munja social step.',
  'munjaRidersReady':
      'Your Munja riders are ready for rides, progress and future challenges.',
  'findRiderBuildCrew':
      'Find another Munja rider, send a request and build your crew.',
  ...
  'acceptRidersBuildCrew': 'Accept riders you know and build your Munja crew.',
  'loadingFriendRequests': 'Loading friend requests...',
  'noPendingRequests': 'No pending requests',
  'nowFriendsWith': 'You and {rider} are now friends.',
  'friendRequestDeclined': 'Friend request from {rider} declined.',
  'declineRequestMessage': 'Decline the friend request from {rider}?',
  'friendRequestsAppearHere':
      'When another Munja rider sends you a friend request, it will appear here.',
  'pendingRequestSingular': 'pending request',
  'pendingRequestsPlural': 'pending requests',
  'enterRiderSearch': 'Enter a @username, e-mail or Munja Friend Code.',
  ...
  'findRiderTitle': 'Find Rider',
  'riderNotFound': 'Rider not found',
  'readyToSearch': 'Ready to search',
  'findAnotherRider': 'Find another rider',
  'findRiderSearchDescription':
      'Search by @username, e-mail or a simple Munja Friend Code. Use whichever method is easiest for you.',
  'riderSearchHint': '@username, e-mail or Friend Code',
  'searchingRiders': 'Searching Munja riders...',
  'thisIsYou': 'This is you',
  'requestReceived': 'Request received',
  'requestSent': 'Request sent',
  'addFriend': 'Add Friend',
  'searchWithCaps': 'SEARCH WITH',
  'friendCode': 'Friend Code',
  'friendRequestSentTo': 'Friend request sent to {rider}.',
  'friendCodeValue': 'Friend Code: {code}',
  'kmRace': '{distance} KM RACE',
  'firstRiderWins': 'First rider to {distance} km wins.',
  'challengeDays': '{count} days',
  'challengeHoursLeft': '{count}h left',
  'youLeadBy': 'You lead by {distance} km.',
  'otherLeadsBy': '{name} leads by {distance} km.',
  'munjaRidesCaps': 'MUNJA RIDES',
  'rideHistoryTitle': 'Ride History',
  'rideHistorySubtitle': 'All your saved rides in one place.',
  'score': 'Score',
  'analyticsNewCaps': 'NEW',
  'advancedAnalyticsCaps': 'ADVANCED ANALYTICS',
  'analyticsThisWeekCaps': 'THIS WEEK',
  'analyticsThisMonthCaps': 'THIS MONTH',
  'analyticsPaceTrendCaps': 'PACE TREND',
  'analyticsConsistencyCaps': 'CONSISTENCY',
  'analyticsBestMonthCaps': 'BEST MONTH',
  'advancedAnalyticsDescription':
      'Weekly trends, monthly comparison and personal insights',
  'unlockWithMunjaProCaps': 'UNLOCK WITH MUNJA PRO',
  'rideSaved': 'Ride Saved',
  'rideScore': 'Ride Score',
  'quickRide': 'Quick Ride',
  'routeSavedSubtitle': 'Your ride route has been saved.',
  'noRouteSaved': 'No route saved',
  'noRouteSavedSubtitle': 'This ride does not contain any saved route points.',
  'achievementsSubtitle': 'Achievements earned during this ride.',
  'firstKilometer': 'First Kilometer',
  'routeRecorded': 'Route Recorded',
  'done': 'Done',
  'mCrystals': 'M-Crystals',
  'rideAnalysisStrongEndurance': 'Strong endurance ride',
  'rideAnalysisFastRide': 'Fast ride',
  'rideAnalysisSolidRide': 'Solid ride',
  'rideAnalysisRideComplete': 'Ride complete',
  'rideAnalysisFreeSummary':
      'You completed {distance} km in {minutes} min with an average speed of {speed} km/h.',
  'rideAnalysisAddSteadyKilometres':
      'For the next ride, try adding a few more steady kilometres.',
  'rideAnalysisSmoothSustainablePace':
      'Focus on a smooth, sustainable pace rather than short speed bursts.',
  'rideAnalysisBuildConsistency':
      'Keep building consistency and add distance gradually.',
  'rideAnalysisAboveNormalPerformance': 'Above your normal performance',
  'rideAnalysisFasterThanUsual': 'Faster than your usual pace',
  'rideAnalysisLongerThanUsual': 'Longer than your usual ride',
  'rideAnalysisVeryConsistent': 'Very consistent ride',
  'rideAnalysisPersonalAnalysis': 'Personal ride analysis',
  'rideAnalysisProBaseSummary': 'This ride was {distance} km at {speed} km/h.',
  'rideAnalysisDistanceAbove':
      'Distance was {percent}% above your recent average.',
  'rideAnalysisDistanceBelow':
      'Distance was {percent}% below your recent average.',
  'rideAnalysisSpeedAbove':
      'Average speed was {percent}% above your usual pace.',
  'rideAnalysisSpeedBelow':
      'Average speed was {percent}% below your usual pace.',
  'rideAnalysisConsistencyScore': 'Ride consistency score: {score}/100.',
  'rideAnalysisExtendedDistanceAndPace':
      'You extended both distance and pace in the same session.',
  'rideAnalysisSmootherBraking':
      'Next ride, focus on smoother speed control and earlier braking.',
  'rideAnalysisRecoverySession':
      'Use the next ride as a lighter recovery session to balance the training load.',
  'rideAnalysisStartEasier':
      'Try starting slightly easier and hold a steadier pace through the middle of the ride.',
  'rideAnalysisPaceProgressing':
      'Your pace is progressing. Keep the next ride controlled and repeat the same effort.',
  'rideAnalysisAddDistance':
      'Build on this ride by adding 5–10% distance while keeping the same smooth pace.',

  'recentRiderSingular': '{count} recent rider',
  'recentRidersPlural': '{count} recent riders',
  'munjaCompeteCaps': 'MUNJA COMPETE',
  'noActiveChallenges': 'No active challenges',
  'acceptedChallengesAppearHere': 'Accepted challenges will appear here.',
  'munjaAnalyticsCaps': 'MUNJA ANALYTICS',
  'munjaProAnalyticsCaps': 'MUNJA PRO ANALYTICS',
  'removePendingChallengeInvitation': 'This removes the pending invitation.',
  'sentChallenges': 'Sent challenges',
  'noPendingChallenges': 'No pending challenges',
  'challengeInvitationAppearHere':
      'When a Munja friend challenges you, the invitation will appear here.',
  'monthlySpecialStartFailed':
      'Monthly Special could not be started. Please try again.',
  'monthlySpecialStarted': '{title} started. You now have 30 full days.',
  'monthlySpecialAlreadyActive': '{title} is already active.',
  'challengeDaysLeftPlural': '{count} days left',
  'challengeDaysLeftSingular': '{count} day left',
  'challengeHoursLeftPlural': '{count} hours left',
  'challengeHoursLeftSingular': '{count} hour left',
  'challengeMinutesLeft': '{count} min left',
  'endsSoon': 'Ends soon',
  'startingCaps': 'STARTING...',
  ...
  'analyticsSubtitle': 'View stats, progress and insights from your rides.',
  'fastPace': 'Fast Pace',
  'pendingChallengeSingular': '{count} pending challenge',
  'pendingChallengesPlural': '{count} pending challenges',
  'challengeIncomingSent': '{incoming} incoming · {sent} sent',
  'challengeIncoming': '{count} incoming',
  'challengeSent': '{count} sent',
};
